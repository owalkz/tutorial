...
$sql = "SELECT * FROM activity_scheduling ORDER BY schedule_id ASC ";
    ...
    <section>
        ...
        <table>
            ...
            <tr>
                ...
                <td><?php echo $rows['act_id'];?></td>
                <td><?php echo $rows['exp_id'];?></td>
                <td><?php echo $rows['comp_id'];?></td>
                <td><?php echo $rows['date_of_activity'];?></td>
                <td><?php echo $rows['extra_notes'];?></td>
            </tr>
            <?php
                }
             ?>
